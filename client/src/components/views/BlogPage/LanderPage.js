    ...
    if(user.userData && (user.userData.userId === userId)){
        return (
            <Layout>
                ...
                <Sidebar  isMaster = {true}  userId = {userId}  handleCategory = {selected => handleCategory(selected)}></Sidebar>
                    <Layout>
                        <HeaderPage props={props} isMaster = {true} userId = {userId} ></HeaderPage>
        ...
        return (
            <Layout>
                <Layout className="site-layout" > 
                <Sidebar  isMaster = {false} userId = {userId} handleCategory = {selected => handleCategory(selected)}></Sidebar>
                    <Layout>
                        <HeaderPage props={props} isMaster = {false} userId = {userId}></HeaderPage>
